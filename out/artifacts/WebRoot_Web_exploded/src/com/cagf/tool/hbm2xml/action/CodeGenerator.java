...
public class CodeGenerator
{
	...
	{
		System.out.println("generating Spring Action configs...");
		...
		Helper.getInstance().generateActionXML(hbmFiles, outputPath, fileName,
				projectDirectory);

		System.out.println("finishing Spring Action configs...");
	}
}